...
insert into bb_product(idProduct, type, ProductName, Description, ProductImage, Price, Active, idDepartment) 
  values(1,'E','CapressoBar Modal #351', 'A fully programmable pump espresso machine and 12-cup coffee maker complete with GoldTone filter', 'capresso.gif', 99.98, 1, 2);
...
insert into bb_product(idProduct, Type, ProductName, Description, ProductImage, Price, Active, idDepartment) 
  values(9,'C','Ethiopia', 'distinctive berry-like flavor and aroma, reminds many of a fruity, memorable wine. ', 'ethiopia.jpg', 15.00, 1, 1);
...
insert into bb_shopper
    values (22, 'Maggie', 'Somners', '287 Walnut Drive', 'Cheasapeake',
            'VA','23321', '7574216559', NULL, 'MargS@infi.net', 'MaryS',
            'pupper', 1, '03-FEB-2012', NULL, 'USA');
insert into bb_shopper
    values (23, 'Kenny', 'Rattmans', '1 Fun Lane', 'South Park',
...
insert into bb_shopper
    values (27, 'Peter', 'Parkers', '1 Queens', 'New York',
